...
EMBED_SIZE=512
IMG_SIZE= 224 #Depends on the backbone
...
for e in range(EPOCH):
    ...
    for i in tqdm(valloader_1):
        ...
        pred=F.cosine_similarity(anchor,target)>0.5
    ...
    print(f"val epoch: {e}, correct: {1-correct/total}")
...
#     total_loss=0
#     model.train()
#     for i in tqdm(sameperson_trainloader):
#         input1=i[0].to(DEVICE)
#         input2=i[1].to(DEVICE)
#         labels=i[2].to(DEVICE)

#         optimizer.zero_grad()
#         emb1,emb2,_=model(input1,input2)
...
#     correct = 0
#     model.eval()
#     for i in tqdm(sameperson_valloader):
#         input1=i[0].to(DEVICE)
#         input2=i[1].to(DEVICE)
#         labels=i[2].to(DEVICE)
